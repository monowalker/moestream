...
echo "## S31 -- MTP on a MoE model, with the control S28 omitted   $(date -Iseconds)"
...
echo
echo "### control: is MTP working on this model at all?"
run "MOESTREAM=0, no MTP"     Ornith-1.5-35B-Q4_K_M.gguf 8192 "-e MOESTREAM=0" ""
run "MOESTREAM=0 + MTP"       Ornith-1.5-35B-Q4_K_M.gguf 8192 "-e MOESTREAM=0" "$MTP"
echo
echo "### with expert streaming"
run "frac=0.40, no MTP"       Ornith-1.5-35B-Q4_K_M.gguf 8192 "-e MOESTREAM=1 -e MOESTREAM_CACHE_FRAC=0.40" ""
run "frac=0.40 + MTP"         Ornith-1.5-35B-Q4_K_M.gguf 8192 "-e MOESTREAM=1 -e MOESTREAM_CACHE_FRAC=0.40" "$MTP"
